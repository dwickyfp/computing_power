...
const route = getRouteApi('/_authenticated/sources/')
...
export function SourcesTable({ data }: DataTableProps) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            const host = String(row.getValue('pg_host')).toLowerCase()
            const searchValue = String(filterValue).toLowerCase()

            return name.includes(searchValue) || host.includes(searchValue)
        },
