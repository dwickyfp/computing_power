...
import { Calendar, Loader2, Save, ArrowLeft, Clock } from 'lucide-react'
      ...
      <Main className='flex flex-1 flex-col gap-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure a cron-based schedule to automatically trigger a flow
              task or linked task.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              ...
              >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Unique schedule name (no spaces)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className='space-y-4'>
                  ...
                  <RadioGroup
                    value={cronMode}
                    onValueChange={(v: any) => setCronMode(v)}
                      ...
                      <div className='grid grid-cols-2 gap-2 md:grid-cols-3'>
                        {CRON_PRESETS.map((p) => (
                          <Button
                            ...
                            size='sm'
                            variant={
                              form.watch('cron_expression') === p.value ||
                              presetType === p.value
                                ? 'default'
                                : 'outline'
                            }
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            5-part crontab: minute hour day month weekday
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Only ACTIVE schedules execute on their cron
                          expression.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
        ...
        {!isNew && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Recent executions triggered by this schedule (auto-refreshes
                every 30s)
              </CardDescription>
            </CardHeader>
            <CardContent>
